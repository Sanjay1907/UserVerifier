                ...
                for (DataSnapshot creatorSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (requestVerificationSnapshot.exists()) {
                        for (DataSnapshot userVerificationData : requestVerificationSnapshot.getChildren()) {
                            ...
                            if ("1".equals(verificationStatus)) { // Check if verification is "1"
                                ...
                                if (name != null && phoneNumber != null) {
                                    ...
                                    TableRow tableRow = (TableRow) LayoutInflater.from( ApprovedRequestActivity.this).inflate(R.layout.table_row, null);
                                    ...
                                    btnViewDetails.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Intent intent = new Intent(ApprovedRequestActivity.this, ViewApprovedActivity.class);
