            ...
            buttonApprove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new AlertDialog.Builder(ViewDetailsActivity.this)
                            ...
                            .setMessage("Are you sure you want to approve the request?")
                                    ...
                                    storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            requestVerificationRef.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(ViewDetailsActivity.this, "Error deleting request_verification: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(ViewDetailsActivity.this, "Error deleting PDF: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            })
